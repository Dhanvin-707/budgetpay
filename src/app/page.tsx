    ...
    <>
      ...
      <FadeIn dir="up" delay={200}>
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <ProductsGrid className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {featured.length === 0 ? (
            ...
            {[
              ...
              <FadeIn key={item.step} dir="up" delay={i * 150}>
                <div className="group rounded-xl border border-border bg-white p-6 relative transition-all hover:-translate-y-1 hover:shadow-lg">
                  <span className="absolute right-4 top-4 text-3xl font-extrabold text-primary/10 transition-all group-hover:text-primary/20">{item.step}</span>

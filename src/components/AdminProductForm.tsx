...
export default function AdminProductForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const body = {
      ...
      pricePaise: Math.round(Number(form.get("pricePaise")) * 100),
      originalPricePaise: form.get("originalPricePaise") ? Math.round(Number(form.get("originalPricePaise")) * 100) : null,
